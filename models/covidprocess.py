...
DEFAULT_PATHS = {
    'PATH_COVID': r"E:\Practice\Challenges\ODS\covid19\Compartmental models\data\csse_covid_19_time_series",
    ...
    'PATH_COUNTRIES': r"E:\Practice\Challenges\ODS\covid19\Compartmental models\data\countries",
